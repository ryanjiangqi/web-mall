<template>
	<div>
		...
		<van-row class='m-bv'>
			<van-col span="8" class='bv'>
				<van-icon name="passed" class='pass' /> 精选品牌</van-col>
			<van-col span="8" class='bv'>
				<van-icon name="passed" class='pass' /> 大V推荐</van-col>
			<van-col span="8" class='bv'>
				<van-icon name="passed" class='pass' /> 无忧退货</van-col>
		</van-row>
